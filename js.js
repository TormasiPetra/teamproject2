...
if (counter === 1 ) {
  ...
  bandName = bandNameGenerator(words.adjectives[randomNameNumber(0, words.adjectives.length )]) + ' ' + bandNameGenerator(words.names[randomNameNumber(0, words.names.length)])
  }
